package ru.jucharick.draw_pic.sprites;

import ru.jucharick.common.MainCanvas;
import ru.jucharick.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("src/main/java/ru/jucharick/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
