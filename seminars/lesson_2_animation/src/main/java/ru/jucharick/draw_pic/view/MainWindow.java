package ru.jucharick.draw_pic.view;

import ru.jucharick.circles.exceptions.BallsOverflowException;
import ru.jucharick.common.CanvasRepaintListener;
import ru.jucharick.common.Interactable;
import ru.jucharick.common.MainCanvas;
import ru.jucharick.draw_pic.sprites.Background;
import ru.jucharick.draw_pic.sprites.Picture;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    private static final String TITLE = "Picachu";
